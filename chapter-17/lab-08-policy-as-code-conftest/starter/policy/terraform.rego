...
# Written in Rego v1 syntax (OPA 1.x default), the syntax used by every Rego listing in the book
# (Chapter 12 §12.5, Chapter 17). Pre-1.0 examples found elsewhere need `opa fmt --v0-v1` first.
package main
